...
EXTRACTION_CASES = [
    ...
    {
        "sentence": "토끼는 들판에서 풀을 먹는다.",
        "predicate": "먹다",
        "roles": {"행위자": {"토끼"}, "장소": {"들판"}, "대상": {"풀"}},
    },
    {
        "sentence": "사슴은 숲에서 잎을 먹는다.",
        "predicate": "먹다",
        "roles": {"행위자": {"사슴"}, "장소": {"숲"}, "대상": {"잎"}},
    },
    {
        "sentence": "철수는 도서관에서 책을 읽는다.",
        "predicate": "읽다",
        "roles": {"행위자": {"철수"}, "장소": {"도서관"}, "대상": {"책"}},
    },
]
